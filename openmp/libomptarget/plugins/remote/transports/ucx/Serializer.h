...
struct SerializerTy {
  ...
  DataAlloc(std::string Message) = 0;
  ...
  DataRetrieve(std::string Message) = 0;

  virtual std::string Data(void *DataBuffer, size_t DataSize,
                           int32_t Value) = 0;
  virtual std::tuple<void *, size_t, int32_t> Data(std::string Message) = 0;
  ...
  TargetRegion(std::string Message) = 0;
  ...
  virtual std::tuple<int32_t, void *, void **, ptrdiff_t *, int32_t, int32_t,
                     int32_t, uint64_t>
  TargetTeamRegion(std::string Message) = 0;
};
...
class ProtobufSerializerTy : public SerializerTy {
  ...
  std::tuple<int32_t, int64_t, void *> DataAlloc(std::string Message) override;
  ...
  DataRetrieve(std::string Message) override;

  std::string Data(void *DataBuffer, size_t DataSize, int32_t Value) override;
  std::tuple<void *, size_t, int32_t> Data(std::string Message) override;
  ...
  TargetRegion(std::string Message) override;
  ...
  std::tuple<int32_t, void *, void **, ptrdiff_t *, int32_t, int32_t, int32_t,
             uint64_t>
  TargetTeamRegion(std::string Message) override;
};
